  ...
  <div>
    <div class="header text-center">
      ...
      <p class="category">
        ...
        >Tristan Edwards</a>. Please checkout the
        <a
        ...
        <div class="md-layout-item md-size-25 md-medium-size-50 md-xsmall-size-100">
          <md-card>
            <md-card-content class="text-center">
              <h5
                class="card-text"
              >A warning message, with a function attached to the "Confirm" Button...</h5>
              <md-button
                class="md-success"
        ...
        <div class="md-layout-item md-size-25 md-medium-size-50 md-xsmall-size-100">
          <md-card>
            <md-card-content class="text-center">
              <h5
                class="card-text"
              >...and by passing a parameter, you can execute something else for "Cancel"</h5>
              <md-button
                class="md-success"
